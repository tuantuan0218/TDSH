...
- 状态：Mac（192.168.1.3）上 copilot-api auth 进程**存活等待中**，
  **device code：`0E77-5510`** → 浏览器打开 **https://github.com/login/device** 输入即授权
...
| 项 | 动作 | 状态 |
|---|---|---|
| **copilot 授权** | 打开 github.com/login/device 输 **`0E77-5510`**（最新；旧码 0989-1311/D3CA-973D/37FA-7F20 已过期） | ⏳ 等待（Mac auth 进程存活） |
