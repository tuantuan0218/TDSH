...
| 3 | ModelScope | modelscope.cn 注册 → 创建 token | `node add-free-api-pool.mjs` |
| 4 | 火山方舟 / 七牛 | volcengine / qiniu 注册领取免费额度 | 同上模板 |
| 5 | DeepLX 翻译 | connect.linux.do 领取 DeepLX Api Key | 翻译类另行评估 |
