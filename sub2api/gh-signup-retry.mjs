...
execSync(`powershell -NoProfile -Command "Set-Clipboard -Value '${creds.password.replace(/'/g, \"''\")}'"`);
...
// 2) 新开一个 InPrivate 标签到 signup
try { execFileSync('cmd.exe', ['/c', 'start', 'msedge', '-inprivate', 'https://github.com/signup'], { stdio: 'ignore' }); console.log('✅ 已开 Edge InPrivate → github.com/signup'); }
